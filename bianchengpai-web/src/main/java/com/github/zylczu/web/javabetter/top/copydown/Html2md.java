package com.github.zylczu.web.javabetter.top.copydown;

import com.github.zylczu.web.javabetter.top.copydown.strategy.*;
import com.github.zylczu.web.javabetter.top.furstenheim.Options;
...
public class Html2md {
    public static void main(String[] args) throws IOException {
        ...
        com.github.zylczu.web.javabetter.top.copydown.HtmlSourceOption option = com.github.zylczu.web.javabetter.top.copydown.HtmlSourceOption.builder()
...
//                .userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537")
                .get();
        // 生成 markdown
        com.github.zylczu.web.javabetter.top.furstenheim.OptionsBuilder optionsBuilder = com.github.zylczu.web.javabetter.top.furstenheim.OptionsBuilder.anOptions();
        // 设置 markdown 选项
        Options options = optionsBuilder
                .withEmDelimiter("*")
                .withBr("\r")
                .withCodeBlockStyle(com.github.zylczu.web.javabetter.top.furstenheim.CodeBlockStyle.FENCED)
                .withHeadingStyle(com.github.zylczu.web.javabetter.top.furstenheim.HeadingStyle.ATX)
                .build();

        // 创建转换器
        com.github.zylczu.web.javabetter.top.furstenheim.CopyDown copyDown = new com.github.zylczu.web.javabetter.top.furstenheim.CopyDown(options);
        ...
        for (UrlHandlerStrategy strategy : strategies) {
            if (strategy.match(url)) {
                ...
                com.github.zylczu.web.javabetter.top.copydown.HtmlSourceResult result = strategy.convertToMD(option);
