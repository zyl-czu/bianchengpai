package com.github.zylczu.web.hook.filter;

import cn.hutool.core.date.StopWatch;

import com.github.zylczu.api.model.context.ReqInfoContext;
import com.github.zylczu.core.async.AsyncUtil;
import com.github.zylczu.core.mdc.MdcUtil;
import com.github.zylczu.core.util.*;
import com.github.zylczu.service.sitemap.service.impl.SitemapServiceImpl;
...
import com.github.zylczu.web.global.GlobalInitService;
...
public class ReqRecordFilter implements Filter {
    ...
    private HttpServletRequest initReqInfo(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            reqInfo.setDeviceId(getOrInitDeviceId(request, response));  // 写入设备id
