...
public class CopyDown {
    public CopyDown () {
        this.options = com.github.zylczu.web.javabetter.top.furstenheim.OptionsBuilder.anOptions().build();
        setUp();
    }
    ...
    public String convert(String input) {
        ...
        com.github.zylczu.web.javabetter.top.furstenheim.CopyNode copyRootNode = new com.github.zylczu.web.javabetter.top.furstenheim.CopyNode(input);
    ...
    private String process (com.github.zylczu.web.javabetter.top.furstenheim.CopyNode node) {
        String result = "";
        for (Node child : node.element.childNodes()) {
            com.github.zylczu.web.javabetter.top.furstenheim.CopyNode copyNodeChild = new com.github.zylczu.web.javabetter.top.furstenheim.CopyNode(child, node);
            String replacement = "";
    ...
    private String replacementForNode (com.github.zylczu.web.javabetter.top.furstenheim.CopyNode node) {
    ...
    class Rules {
        ...
        public Rules () {
            ...
            addRule("heading", new Rule(new String[]{"h1", "h2", "h3", "h4", "h5", "h6" }, (content, element) -> {
                ...
                if (options.headingStyle == com.github.zylczu.web.javabetter.top.furstenheim.HeadingStyle.SETEXT && hLevel < 3) {
...
//                content = content.replaceAll("(?m)\n", "\n");
            ...
            addRule("inlineLink", new Rule((element) -> {
                return options.linkStyle == com.github.zylczu.web.javabetter.top.furstenheim.LinkStyle.INLINED
            ...
            addRule("referenceLink", new Rule((element) -> {
                return options.linkStyle == com.github.zylczu.web.javabetter.top.furstenheim.LinkStyle.REFERENCED
                       && element.nodeName().equals("a")
                       && element.attr("href").length() != 0;
            }, (content, element) -> {
                String href = element.attr("href");
