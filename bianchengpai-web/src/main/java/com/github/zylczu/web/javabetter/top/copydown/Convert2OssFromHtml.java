...
public class Convert2OssFromHtml {
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        // 原创
        // 原创需要指定路径
        com.github.zylczu.web.javabetter.top.copydown.ImgOption imgOption = com.github.zylczu.web.javabetter.top.copydown.ImgOption.builder()
        ...
        // 读取全部内容
        String content = com.github.zylczu.web.javabetter.top.copydown.OSSUtil.upload(fileReader.readString(), imgOption);
