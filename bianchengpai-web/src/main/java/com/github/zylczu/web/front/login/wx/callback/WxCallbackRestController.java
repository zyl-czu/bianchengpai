package com.github.zylczu.web.front.login.wx.callback;

import com.github.zylczu.api.model.enums.pay.ThirdPayWayEnum;
import com.github.zylczu.api.model.vo.user.wx.BaseWxMsgResVo;
import com.github.zylczu.api.model.vo.user.wx.WxTxtMsgReqVo;
import com.github.zylczu.api.model.vo.user.wx.WxTxtMsgResVo;
import com.github.zylczu.core.util.SpringUtil;
import com.github.zylczu.service.article.service.ArticlePayService;
import com.github.zylczu.service.notify.service.NotifyService;
...
import com.github.zylczu.web.front.login.wx.helper.WxAckHelper;
import com.github.zylczu.web.front.login.wx.helper.WxLoginHelper;
    ...
    public BaseWxMsgResVo callBack(@RequestBody WxTxtMsgReqVo msg) {
        ...
        if ("subscribe".equals(msg.getEvent()) || "scan".equalsIgnoreCase(msg.getEvent())) {
            ...
            if (StringUtils.isNotBlank(key) || key.startsWith("qrscene_")) {
                ...
                sessionService.autoRegisterWxUserInfo(msg.getFromUserName());  // 注册登陆
