...
# file to upload
WEB_PATH="bianchengpai-web"
EXECUTABLE_JAR_NAME="bianchengpai-web-0.0.1-SNAPSHOT.jar"
...
SSH_HOST_PRO=("admin@47.111.120.92")
#WORK_DIR_PRO="/home/admin/workspace/paicoding-forum/"
WORK_DIR_PRO="/root/workspace/bianchengpai/"
