package com.github.zylczu.service.image.oss.impl;
...
import com.github.zylczu.core.config.ImageProperties;
import com.github.zylczu.core.util.Md5Util;
import com.github.zylczu.core.util.StopWatchUtil;
import com.github.zylczu.service.image.oss.ImageUploader;
...
public class AliOssWrapper implements ImageUploader, InitializingBean, DisposableBean {
    ...
    public String upload(byte[] bytes, String fileType) {
        ...
        String bucketName = properties.getOss().getBucket();
...
//            return true;
//        }
        if (StringUtils.isNotBlank(properties.getOss().getHost()) && fileUrl.startsWith("https://zylzyl.oss-cn-beijing.aliyuncs.com")) {
            return true;
        }
